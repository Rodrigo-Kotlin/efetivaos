...
export type ComparisonSortKey =
  "item" | "best_cost" | "category" | "validity" | "suggested_price";

export type OfferGroup = "eligible" | "historical";

export type CommercialStatusFilter = "all" | PriceEffectiveStatus;
export type CommercialSourceFilter = "all" | "automatic" | "manual" | "own";
export type CommercialOriginFilter = "all" | "own" | "quotation";
