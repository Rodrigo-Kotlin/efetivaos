...
const OwnPricesPage = lazy(() => import('@/features/pricing/own-prices/own-prices-page'))
...
const ImportHistoryPage = lazy(() => import('@/features/finance/pages/import-history-page'))
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'pricing/own-prices', element: pending(<OwnPricesPage />) },
          {
            element: <AdminRoute />,
          ...
          { path: 'finance/import-history', element: pending(<ImportHistoryPage />) },
