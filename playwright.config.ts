...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'chromium',
      testMatch: /(quotation-draft|comparison-flow|pricing-rules-flow|price-approval-admin|pricing-dashboard|crm-admin|ui-stability|own-price-proposal)\.spec\.ts/,
    ...
    {
      name: 'team-chromium',
      testMatch: /(pricing-rules-team|price-approval-team|crm-team|own-price-proposal)\.spec\.ts/,
      dependencies: ['chromium'],
      use: {
        ...devices['Desktop Chrome'],
